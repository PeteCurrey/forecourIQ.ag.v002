      ...
      <div className="max-w-container mx-auto">
        ...
        <div className="flex flex-col">
          {TESTIMONIALS.map((t, i) => (
            <div 
              key={i}
              className="testimonial-block grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 py-20 border-t border-[#252B37]/30 first:border-t-0"
            >
              {/* Image Placeholder */}
              <div className="lg:col-span-5 aspect-[3/4] bg-[#0D0F14] border border-[#252B37] rounded-[2px] flex items-center justify-center p-12 text-center">
                <span className="font-cormorant font-300 italic text-[13px] text-[#5C6678]">
                  [Dealer portrait photography — to be supplied]
                </span>
              </div>
              ...
              <div className="lg:col-span-7 flex flex-col justify-center">
                ...
                <span className="font-mono text-[11px] text-[#39FF14] tracking-[0.16em] uppercase">
                  {t.metric}
                </span>
              </div>
            </div>
