      ...
      <div className="max-w-container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-12">
          {INTEGRATIONS.map((item, i) => (
            <div 
              key={i} 
              className="integration-cell group flex flex-col gap-2 pb-6 border-b border-[#252B37]/30 transition-all duration-300 hover:border-[#0EA5E9]/40"
            >
              <h4 className="font-syne font-700 text-[16px] text-[#EDE8DC] group-hover:text-[#0EA5E9] transition-colors duration-300">
                {item.name}
              </h4>
